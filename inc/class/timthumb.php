...
if(! isset($ALLOWED_SITES)){
	$bsurl = str_replace('www.', '', $_SERVER['HTTP_HOST']);
	...
	public function __construct(){
		...
		if(FILE_CACHE_DIRECTORY){
			if(! is_dir(FILE_CACHE_DIRECTORY)){
				...
				@chmod(FILE_CACHE_DIRECTORY, 0755); /* By GhozyLab */
				if(! is_dir(FILE_CACHE_DIRECTORY)){
...
/*------By GhozyLab----------------------------------------------------------------------------*/			
		...
		//$this->src = $this->param('src');  /* By GhozyLab */
...
/*------End By GhozyLab----------------------------------------------------------------------------*/		
		...
		//$this->src = preg_replace('/https?:\/\/(?:www\.)?' . $this->myHost . '/i', '', $this->src); By GhozyLab / For Multisite
